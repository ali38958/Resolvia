...
app.get('/api/pages', authenticateToken, (req, res) => {
    ...
    if (role === 'superadmin') {
        ...
        const pages = [
            ...
            { name: "natures", file: "/admin/natures", icon: "fa fa-tags", badge: 0 },

            // Location Structure
            { name: "Colonies", file: "/admin/colonies", icon: "fa fa-city", badge: 0 },
            { name: "Buildings", file: "/admin/buildings", icon: "fa fa-building", badge: 0 },
            { name: "Floors", file: "/admin/floors-management", icon: "fa fa-layer-group", badge: 0 },

            // User Management
            { name: "All Customers", file: "/admin/all-customers", icon: "fa fa-user-friends", badge: 0 },
            { name: "staff", file: "/admin/staff-management", icon: "fa fa-screwdriver-wrench", badge: 0 },
            { name: "Handlers", file: "/admin/handlers", icon: "fa fa-headset", badge: 0 },
            { name: "Admins", file: "/admin/admins", icon: "fa fa-user-shield", badge: 0 },

            // Reporting Section
            { name: "Complaints Report", file: "/admin/complaints-report", icon: "fa-solid fa-file-lines", badge: 0 },
            { name: "Found Items Report", file: "/admin/found-items-report", icon: "fa-solid fa-file-lines", badge: 0 },
            { name: "Handlers Report", file: "/admin/handlers-reporting", icon: "fa-solid fa-file-lines", badge: 0 },
            { name: "staff Report", file: "/admin/staff-reporting", icon: "fa-solid fa-file-lines", badge: 0 },
