...
app.get('/api/auth/profile-image', authenticateToken, async (req, res) => {
    try {
...
app.get('/api/complaints/natures', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.get('/api/complaints/locations', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.get('/api/complaints/colonies', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
 ...
 * @access  Public
 */
app.get('/api/complaint-center/get-category-list', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
 ...
 * @access  Public
 */
app.get('/api/complaint-center/get-location-list', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.get('/api/colonies', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const [colonies] = await pool.query(`
            SELECT 
...
app.get('/api/colonies/search', authenticateToken, async (req, res) => {
    try {
        const { q } = req.query;
        const pool = await getDBPool();
...
app.post('/api/colonies', authenticateToken, async (req, res) => {
    try {
        const { name } = req.body;
...
app.put('/api/colonies/:id', authenticateToken, async (req, res) => {
    try {
...
app.delete('/api/colonies/:id', authenticateToken, async (req, res) => {
    try {
        const colonyId = req.params.id;
        const pool = await getDBPool();
...
app.get('/api/colonies/:id', authenticateToken, async (req, res) => {
    try {
        const colonyId = req.params.id;
        const pool = await getDBPool();
...
app.get('/api/buildings/search', authenticateToken, async (req, res) => {
    try {
...
app.get('/api/coloniesdropdown', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const [colonies] = await pool.query(`
...
app.post('/api/buildings', authenticateToken, buildingUpload.single('image'), async (req, res) => {
    try {
...
app.put('/api/buildings/:id', authenticateToken, buildingUpload.single('image'), async (req, res) => {
    try {
        const buildingId = req.params.id;
...
app.delete('/api/buildings/:id', authenticateToken, async (req, res) => {
    try {
        const buildingId = req.params.id;
        const pool = await getDBPool();
...
app.use('/assets/buildings', authenticateToken, express.static(path.join(__dirname, 'assets', 'buildings')));
...
app.get('/api/floors-management/colonies', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const [colonies] = await pool.query(`
            SELECT id, name FROM colony ORDER BY name
...
app.get('/api/floors-management/buildings/:colonyId', authenticateToken, async (req, res) => {
    try {
...
app.get('/api/floors-management/floors/:buildingId', authenticateToken, async (req, res) => {
    try {
...
app.get('/api/floors-management/all-data', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.get('/api/floors-management/floor-details/:floorId', authenticateToken, async (req, res) => {
    try {
...
app.get('/api/floors-management/room-types', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.post('/api/floors-management/floors', authenticateToken, floorUpload.single('image'), async (req, res) => {
    try {
...
app.put('/api/floors-management/floors/:id', authenticateToken, floorUpload.single('image'), async (req, res) => {
    try {
...
app.delete('/api/floors-management/floors/:id', authenticateToken, async (req, res) => {
    try {
        const floorId = req.params.id;
        const pool = await getDBPool();
...
app.post('/api/floors-management/rooms', authenticateToken, async (req, res) => {
    try {
...
app.put('/api/floors-management/rooms/:id', authenticateToken, async (req, res) => {
    try {
...
app.delete('/api/floors-management/rooms/:id', authenticateToken, async (req, res) => {
    try {
        const roomId = req.params.id;
        const pool = await getDBPool();
...
app.post('/api/floors-management/room-types', authenticateToken, async (req, res) => {
    try {
        const { name } = req.body;
...
app.delete('/api/floors-management/room-types/:id', authenticateToken, async (req, res) => {
    try {
...
app.use('/assets/floors', authenticateToken, express.static(path.join(__dirname, 'assets', 'floors')));
...
app.get('/api/natures/:id', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.post('/api/natures', authenticateToken, async (req, res) => {
    let connection;
    try {
        const pool = await getDBPool();
...
// PUT update nature
app.put('/api/natures/:id', authenticateToken, async (req, res) => {
    let connection;
    try {
        const pool = await getDBPool();
        connection = await pool.getConnection();
...
app.put('/api/natures/:id/types', authenticateToken, async (req, res) => {
    let connection;
    try {
        const pool = await getDBPool();
        connection = await pool.getConnection();
...
// DELETE nature
app.delete('/api/natures/:id', authenticateToken, async (req, res) => {
    let connection;
    try {
        const pool = await getDBPool();
        connection = await pool.getConnection();
...
// DELETE nature type
app.delete('/api/nature-types/:id', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const typeId = req.params.id;
...
// Get admin by ID
app.get('/api/admins/:id', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const [rows] = await pool.execute(
...
// Add new admin
app.post('/api/admins', authenticateToken, adminUpload.single('picture'), async (req, res) => {
    try {
        const pool = await getDBPool();
...
// Update admin
app.put('/api/admins/:id', authenticateToken, adminUpload.single('picture'), async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.post('/api/staff', authenticateToken, upload.single('picture'), async (req, res) => {
    try {
        const pool = await getDBPool();
...
// Update staff
app.put('/api/staff/:id', authenticateToken, upload.single('picture'), async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.get('/api/complaint-receivers', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const page = parseInt(req.query.page) || 1;
        const limit = parseInt(req.query.limit) || 10;
...
app.get('/api/complaint-receivers/:id', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const [rows] = await pool.execute(
...
app.post('/api/complaint-receivers', authenticateToken, complaintManagerUpload.single('picture'), async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.put('/api/complaint-receivers/:id', authenticateToken, complaintManagerUpload.single('picture'), async (req, res) => {
    try {
        const pool = await getDBPool();
...
app.delete('/api/complaint-receivers/:id', authenticateToken, async (req, res) => {
    try {
        const pool = await getDBPool();
        const managerId = req.params.id;
...
app.get('/api/priorities/:id', authenticateToken, async (req, res) => {
    try {
        const db = await getDBPool();
...
// Update priority
app.put('/api/priorities/:id', authenticateToken, async (req, res) => {
    try {
        const { name, value } = req.body;
...
app.use('/assets/found', authenticateToken, express.static(path.join(__dirname, 'assets', 'found')));
...
app.use((req, res, next) => {
    try {
        ...
        // Public access (non-protected folders)
        if (!protectedFolders.includes(firstSegment)) {
            ...
            // If accessing auth-related pages
            ...
            // Serve normally if no valid token
        ...
        const checkRoleAndServe = (tokenData) => {
            ...
            // Prevent normal admin from accessing admins.html
            if (
                userRole === 'admin' &&
                userRole !== 'superadmin' &&
